...
Private Sub cmdSave_Click()
    ...
    With rs
        ...
        .Update "FName", txtFName.Text
        .Update "MName", txtMName.Text
        .Update "LName", txtLName.Text
        .Update "Pin", txtPin.Text
        .Update "Gender", cmbGender.Text
        .Update "Country", cmbCountry.Text
        .Update "Month", cmbMonth.Text
        .Update "Year", cmbYear.Text
        .Update "Day", cmbDate.Text
    
    End With
    
    MsgBox "Member Detail modified successfully", vbInformation + vbOKOnly, "Update"
    Unload Me
    frmFirst.Show
End Sub
